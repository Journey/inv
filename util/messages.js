jQuery.sap.declare("sap.mtk.poc.IGA.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

sap.mtk.poc.IGA.util.messages = {};

// Show an error dialog with information from the oData response object.
// oParameter - The object containing error information
sap.mtk.poc.IGA.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = sap.mtk.poc.IGA.util.messages._parseError(oParameter);
...
sap.mtk.poc.IGA.util.messages.getErrorContent = function(oParameter) {
	return sap.mtk.poc.IGA.util.messages._parseError(oParameter).sMessage;
};

sap.mtk.poc.IGA.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oParameters = null,
		oResponse = null,
