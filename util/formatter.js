jQuery.sap.declare("sap.mtk.poc.IGA.util.formatter");

sap.mtk.poc.IGA.util.formatter = {};
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.formatMyReview = function(bIsReviewOfCurrentUser, sUserName) {
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.formatHelpfulCount = function(iHelpfulCount) {
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.negateBoolean = function(bValue) {
    return !bValue;
};
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.intToString = function(iValue) {
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.formatAvailabilityText = function(iAvailability) {
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.formatAvailabilityStatus = function(iAvailability) {
 ...
 * @public
 */
sap.mtk.poc.IGA.util.formatter.formatMeasure = function(fMeasure, sUnit) {
